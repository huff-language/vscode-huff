...
class MacroDebuggerViewProvider {
  ...
  resolveWebviewView(webviewView, context, _token) {
    ...
    if (!this._currentFile && context && context.state)
      this._currentFile = context.state.currentFile || null;
    if (!this._macros && context && context.state)
      this._macros = context.state.macros || null;
  ...
  getHtmlForWebView(webview) {
    ...
    const styleVSCodeUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionURI, "webview", "css", "vscode.css")
    );
    const styleMainUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionURI, "webview", "css", "main.css")
    );
                ...
                <html>
                    ...
                    <body>
                        ...
                        <form>
                            ...
                            <input class="call-value-checkbox" type="checkbox" id="call-value-checkbox" name="call-value-checkbox">
                            <label for="call-value-checkbox">With Value</label>
                            </br>
                            <input class="call-value-input" type="text" id="call-value-input" value="Enter Value">
